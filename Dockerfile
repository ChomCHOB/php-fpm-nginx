...
# install nginx
# ref: https://github.com/ngineered/nginx-php-fpm
...
ARG CUSTOM_BUILD_PKGS=" \
    gcc linux-headers \
    libffi-dev augeas-dev musl-dev \
    imagemagick-dev libtool autoconf g++ make \
    "
...
ARG PHP_EXT_LIST=" \
    ...
    opcache"
# curl iconv dom session json pdo_sqlite
